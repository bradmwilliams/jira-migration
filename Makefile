...
GO_LD_EXTRAFLAGS=-X github.com/bradmwilliams/jira-migration/vendor/k8s.io/client-go/pkg/version.gitCommit=$(shell git rev-parse HEAD) -X github.com/bradmwilliams/jira-migration/vendor/k8s.io/client-go/pkg/version.gitVersion=${SOURCE_GIT_TAG} -X k8s.io/test-infra/prow/version.Name=jira-migration -X k8s.io/test-infra/prow/version.Version=${version}
